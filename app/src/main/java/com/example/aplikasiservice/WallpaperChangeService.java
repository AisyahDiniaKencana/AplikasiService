...
public class WallpaperChangeService extends Service implements Runnable {
    private int walpaperId[] = {R.drawable.walpaper1, R.drawable.walpaper2};
    private int waktu;
    private int FLAG = 0;
    private Thread t;
...
//    @Nullable
    ...
    public int onStartCommand(Intent intent, int flag, int startId){
        ...
        gambar = BitmapFactory.decodeResource(getResources(),walpaperId[0]);
        gambar1 = BitmapFactory.decodeResource(getResources(),walpaperId[1]);
